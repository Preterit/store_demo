                    ...
                    <c:forEach items="${cart.cartItems}" var="item">
                        <tr class="active">
                            <td width="60" width="40%">
                                ...
                                <img src="${pageContext.request.contextPath}/${item.productBean.pimage}" width="70"
                                     height="60">
                            </td>
                            <td width="30%">
                                <a target="_blank"> ${item.productBean.pname}</a>
                            </td>
                            <td width="20%">
                                ￥${item.productBean.shop_price}
                            </td>
                            <td width="10%">
                            ...
                            <td>
                                <a href="javascript:void(0)" class="delete" title="${item.productBean.pid}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
<script>
    ...
    $(function () {
        ...
        $(".delete").click(function () {
            var pid = this.title;
            if (confirm("忍心删除我吗?")) {
                location.href = "${pageContext.request.contextPath}/CartServlet?method=deleteCart&pid=" + pid;
            }
        });
    });
